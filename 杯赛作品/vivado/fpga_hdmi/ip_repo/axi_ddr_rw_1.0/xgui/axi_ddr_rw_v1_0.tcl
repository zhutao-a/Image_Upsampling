...
proc init_gui { IPINST } {
  ...
  set C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ [ipgui::add_param $IPINST -name "C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ"]
  set_property tooltip {Base Read Addr for 1k image in DDR} ${C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ}
  ipgui::add_param $IPINST -name "C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE"
  ipgui::add_param $IPINST -name "C_M_AXI_BURST_LEN_READ"
  ipgui::add_param $IPINST -name "C_M_AXI_BURST_LEN_WRITE"

}

proc update_PARAM_VALUE.C_M_AXI_BURST_LEN_READ { PARAM_VALUE.C_M_AXI_BURST_LEN_READ } {
	# Procedure called to update C_M_AXI_BURST_LEN_READ when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXI_BURST_LEN_READ { PARAM_VALUE.C_M_AXI_BURST_LEN_READ } {
	# Procedure called to validate C_M_AXI_BURST_LEN_READ
	return true
}

proc update_PARAM_VALUE.C_M_AXI_BURST_LEN_WRITE { PARAM_VALUE.C_M_AXI_BURST_LEN_WRITE } {
	# Procedure called to update C_M_AXI_BURST_LEN_WRITE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXI_BURST_LEN_WRITE { PARAM_VALUE.C_M_AXI_BURST_LEN_WRITE } {
	# Procedure called to validate C_M_AXI_BURST_LEN_WRITE
	return true
}

proc update_PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ { PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ } {
	# Procedure called to update C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ { PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ } {
	# Procedure called to validate C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ
	return true
}

proc update_PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE { PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE } {
	# Procedure called to update C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE { PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE } {
	# Procedure called to validate C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE
	return true
}
...
proc update_MODELPARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ { MODELPARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ}] ${MODELPARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_READ}
}

proc update_MODELPARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE { MODELPARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE}] ${MODELPARAM_VALUE.C_M_AXI_TARGET_SLAVE_BASE_ADDR_WRITE}
}

proc update_MODELPARAM_VALUE.C_M_AXI_BURST_LEN_READ { MODELPARAM_VALUE.C_M_AXI_BURST_LEN_READ PARAM_VALUE.C_M_AXI_BURST_LEN_READ } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXI_BURST_LEN_READ}] ${MODELPARAM_VALUE.C_M_AXI_BURST_LEN_READ}
}

proc update_MODELPARAM_VALUE.C_M_AXI_BURST_LEN_WRITE { MODELPARAM_VALUE.C_M_AXI_BURST_LEN_WRITE PARAM_VALUE.C_M_AXI_BURST_LEN_WRITE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXI_BURST_LEN_WRITE}] ${MODELPARAM_VALUE.C_M_AXI_BURST_LEN_WRITE}
}
