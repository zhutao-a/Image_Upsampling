...
HD_PWD='C:/Users/master/Desktop/final/CICC1837比赛资料/杯赛作品/vivado/fpga_hdmi/fpga_jjw1.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log sys_bd_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sys_bd_design_wrapper.tcl -notrace
